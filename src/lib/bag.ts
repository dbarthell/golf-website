...
export const DEFAULT_CLUBS: BagClub[] = [
  ...
  { id: '5w',  label: '5W',  category: 'wood',   order: 2,  hasPelz: false },
  { id: '3h',  label: '3H',  category: 'hybrid', order: 3,  hasPelz: false },
  { id: '4h',  label: '4H',  category: 'hybrid', order: 4,  hasPelz: false },
  { id: '4i',  label: '4i',  category: 'iron',   order: 5,  hasPelz: true  },
  { id: '5i',  label: '5i',  category: 'iron',   order: 6,  hasPelz: true  },
  { id: '6i',  label: '6i',  category: 'iron',   order: 7,  hasPelz: true  },
  { id: '7i',  label: '7i',  category: 'iron',   order: 8,  hasPelz: true  },
  { id: '8i',  label: '8i',  category: 'iron',   order: 9,  hasPelz: true  },
  { id: '9i',  label: '9i',  category: 'iron',   order: 10, hasPelz: true  },
  { id: 'pw',  label: 'PW',  category: 'wedge',  order: 11, hasPelz: true  },
  { id: 'gw',  label: 'GW',  category: 'wedge',  order: 12, hasPelz: true  },
  { id: 'sw',  label: 'SW',  category: 'wedge',  order: 13, hasPelz: true  },
  { id: 'lw',  label: 'LW',  category: 'wedge',  order: 14, hasPelz: true  },
];

/** Extra clubs a user might want to add (not in default set) */
export const EXTRA_CLUBS: BagClub[] = [
  { id: '2i',  label: '2i',       category: 'iron',   order: 4,  hasPelz: true  },
  { id: '3i',  label: '3i',       category: 'iron',   order: 4,  hasPelz: true  },
